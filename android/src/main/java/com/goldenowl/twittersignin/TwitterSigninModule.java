...
public static TwitterSigninModule twitterSigninModule;

public TwitterSigninModule(ReactApplicationContext reactContext) {
    super(reactContext);
    reactContext.addActivityEventListener(this);
    this.reactContext = reactContext;
    twitterSigninModule = this;

}

public  static TwitterSigninModule getTwitterAuthClientInstance(){
    return  twitterSigninModule;
}
...
public boolean ForceFullyCallOnActivityResult(int requestCode,int resultCode,Intent data){
    boolean isSuccess;
